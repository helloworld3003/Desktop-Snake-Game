<img src="../icon.ico" align="left" width="65" height="65" hspace="10">
...
- **The Gameplay:** Use `W, A, S, D` or `Arrow Keys` to slither around the desktop grid and "eat" other icons to grow longer. 
